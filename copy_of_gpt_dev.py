...
Original file is located at
    https://colab.research.google.com/drive/1uAGnPOfLQE6wlkmKZ8LTpeWcQ42FDdyI
"""

!pip install jovian --q
import jovian
jovian.utils.colab.set_colab_file_id('lBz0oJP4zOfTu3Zd2QhFAvY0EXj_ll9E6') # This should now work!
...
generator = nn.Sequential(
    ...
    nn.ConvTranspose2d(128, 512, kernel_size=4, stride=1, padding=0, bias=False), # Replace latent_size with its intended value (128)
    nn.BatchNorm2d(512),
    nn.ReLU(True),
    # out: 512 x 4 x 4
